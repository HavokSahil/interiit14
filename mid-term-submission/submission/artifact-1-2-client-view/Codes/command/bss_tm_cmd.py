...
class BssTmRequestBuilder:
    ...
    def _encode_neighbor(n: "Neighbor") -> str:
        ...
        Logger.log_info(
            f"Neighbor encode values: "
            f"bssid={n.bssid!r}, bssid_info={n.bssid_info!r}, "
            f"oper_class={n.oper_class!r}, channel={n.channel!r}, phy_type={n.phy_type!r}"
        )
        if not all([n.bssid, n.bssid_info is not None, n.oper_class is not None, n.channel , n.phy_type is not None]):
