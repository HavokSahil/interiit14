...
@unique
class OperatingClass(IntEnum):
    """Common 802.11 operating classes for 2.4GHz and 5GHz."""
    CLASS_2_4GHZ_20MHZ = 81
    CLASS_2_4GHZ_40MHZ = 82
    CLASS_5GHZ_20MHZ = 115
    CLASS_5GHZ_40MHZ = 116
    CLASS_5GHZ_80MHZ = 117

@unique
class MeasurementMode(IntEnum):
    """Beacon measurement modes per IEEE 802.11k."""
    PASSIVE = 0
    ACTIVE = 1
    TABLE = 2

@unique
class ReqMode(IntEnum):
    """Request modes for REQ_BEACON command."""
    NORMAL = 0
    LCI = 1 << 0
    CIVIC = 1 << 1

class RequestBeaconCommandBuilder:
    """
